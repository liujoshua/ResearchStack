...
/**
 * An TaskResult object is a result that contains all the step results generated from one run of a task or ordered
 * task (that is, {@link org.researchstack.foundation.task.Task} or {@link org.researchstack.foundation.task.OrderedTask}).
 * <p>
 * A task result is typically generated by the framework as the task proceeds. When the task completes, it may be
 * appropriate to serialize it for transmission to a server, or to immediately perform analysis on it.
 * <p>
 * The <code>results</code> property contains the step results for the task.
 */
public class TaskResult extends Result {
    private Map<String, IResult> results;
     ...
     */
    public Map<String, IResult> getResults() {
        return results;
    }
     ...
     */
    public IResult getStepResult(String identifier) {
     ...
     *
     * @param identifier
     *         the Step and StepResult's identifier
     * @param stepResult
     *         the StepResult for this identifier
     */
    public void setStepResultForStepIdentifier(String identifier, IResult stepResult) {
