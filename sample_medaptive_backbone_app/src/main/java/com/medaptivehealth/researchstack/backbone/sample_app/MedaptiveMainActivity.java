...
public class MedaptiveMainActivity extends PinCodeActivity {
    ...
    void clearData() {
        MedaptiveAppPrefs appPrefs = MedaptiveAppPrefs.getInstance(this);
    ...
    private void initViews() {
        MedaptiveAppPrefs prefs = MedaptiveAppPrefs.getInstance(this);
    ...
    private void launchConsent() {
        ...
        Intent intent = ViewMedaptiveBackboneInteropTaskActivity.newIntent(this, consentTask);
    ...
    private void launchSurvey() {
        ...
        Intent intent = ViewMedaptiveBackboneInteropTaskActivity.newIntent(this, task);
