package org.sagebionetworks.researchstack.backbone.model;
...
public class ConsentSection implements Serializable
{
     ...
     * for an {@link org.sagebionetworks.researchstack.backbone.step.ConsentVisualStep} object. It is ignored for a
