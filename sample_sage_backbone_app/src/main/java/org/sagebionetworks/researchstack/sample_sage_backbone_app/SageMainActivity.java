...
import org.sagebionetworks.researchstack.backbone.model.ConsentSignature;
import org.sagebionetworks.researchstack.backbone.result.StepResult;
import org.sagebionetworks.researchstack.backbone.result.TaskResult;
import org.sagebionetworks.researchstack.backbone.step.ConsentDocumentStep;
import org.sagebionetworks.researchstack.backbone.step.ConsentSignatureStep;
...
import org.sagebionetworks.researchstack.backbone.ui.step.layout.ConsentSignatureStepLayout;

import java.util.ArrayList;
import java.util.Collections;

public class SageMainActivity extends PinCodeActivity
{
    ...
    void clearData()
    {
        SageAppPrefs appPrefs = SageAppPrefs.getInstance(this);
    ...
    {
        SageAppPrefs prefs = SageAppPrefs.getInstance(this);
    ...
    private void launchConsent()
    {
        ...
        Intent intent = ViewSageBackboneInteropTaskActivity.newIntent(this, consentTask);
    ...
    private void launchSurvey()
    {
        ...
        Intent intent = ViewSageBackboneInteropTaskActivity.newIntent(this, task);
